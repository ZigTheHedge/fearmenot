            ...
            return Commands.literal("add")
                    ...
                    .then(Commands.argument("fearedone", EntityArgument.player())
                        .executes(cs -> {
                            ...
                            {
                                cs.getSource().sendFailure(Component.translatable("cmd.add.fail", dest.getDisplayName()));
                                return 0;
                            }
                            cs.getSource().sendSuccess(Component.translatable("cmd.add.success", dest.getDisplayName()), false);
